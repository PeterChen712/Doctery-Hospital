...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="flex items-center">
            <div
                class="flex items-center gap-2 mb-6 bg-gradient-to-r from-blue-400 to-blue-600 p-4 rounded-lg shadow-lg w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <!-- Statistik Dokter -->
            <div
                class="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-indigo-200">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'doctor']) }}"
                    class="text-sm text-indigo-600 hover:text-indigo-800">Lihat semua dokter →</a>
            </div>

            <!-- Statistik Pasien -->
            <div
                class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-200">
                <div class="flex items-center justify-between mb-4">
                    <div>
                ...
                <a href="{{ route('admin.users.index', ['role' => 'patient']) }}"
                    class="text-sm text-green-600 hover:text-green-800">Lihat semua pasien →</a>
            </div>

            <!-- Statistik Admin -->
            <div
                class="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-purple-200">
                <div class="flex items-center justify-between mb-4">
                    <div>
                ...
                <a href="{{ route('admin.users.index', ['role' => 'admin']) }}"
                    class="text-sm text-purple-600 hover:text-purple-800">Kelola admin →</a>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg shadow-md border border-blue-200">
                ...
                <div class="space-y-4">
                    @forelse ($activeDoctors as $doctor)
                        <div
                            class="flex items-center justify-between p-4 bg-white hover:bg-blue-50 rounded-lg transition-colors duration-150 border border-blue-200">
