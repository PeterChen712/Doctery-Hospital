    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">Silakan buat kata sandi baru Anda</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}"
                            class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                            required autofocus>
                    </div>
                    @error('email')
