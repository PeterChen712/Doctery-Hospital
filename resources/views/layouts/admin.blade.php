        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white cursor-pointer select-none ml-2 hover:text-gray-600 dark:hover:text-gray-300">Admin
                        Portal</span>
                </div>
                    ...
                    <ul id="dropdown-reports" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="{{ route('admin.reports.medicines') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Medicines
                                Report</a>
                        </li>
                    </ul>
                </li>
